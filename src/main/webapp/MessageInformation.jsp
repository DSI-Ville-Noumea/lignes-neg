    ...
    <TR>
      ...
      <TABLE border="1" width="590" class="TableauEcran">
        ...
        <TBODY>
          ...
          <TR>
            <TD align="center"><INPUT type="submit" name="<%=process.getNOM_PB_OK()%>" value="OK" class="Bouton"><%--METADATA type="DynamicData" startspan
<INPUT type="hidden" dynamicelement name="JSP" valueproperty="process.JSP">
--%><INPUT name="JSP" type="hidden" value="<%= process.getJSP() %>"><%--METADATA type="DynamicData" endspan--%></TD>
          </TR>
        </TBODY>
      </TABLE>
      </FORM>
